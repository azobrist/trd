...
g++ -o libxilinxlib.so -fpermissive -DK7_TRD -DPM_SUPPORT -shared -lpthread -Wl,-soname,libxilinx.so -I/usr/lib/jvm/java-1.8.0-openjdk-arm64/include -I/usr/lib/jvm/java-1.8.0-openjdk-arm64/include/linux -I. com_xilinx_ultrascale_jni_DriverInfoGen.cpp threads.cpp -Bstatic -lc -fPIC
